      ...
      <td class="addPictureTableTD">
        <div>
          ...
          <table class="table table-striped table-bordered table-hover  table-condensed">
            ...
            <tbody>
            <c:forEach items="${requestScope.pisSingle}" var="pi">
              <tr>
                <td>${pi.id}</td>
                <td>
                  <a title="点击查看原图" href="imgs/productSingle/${pi.product.id}.jpg"><img height="50px" src="imgs/productSingle/${pi.product.id}.jpg"></a>
                </td>
      ...
      <td class="addPictureTableTD">
        <div>
          ...
          <table class="table table-striped table-bordered table-hover  table-condensed">
            ...
            <tbody>
            <c:forEach items="${requestScope.pisDetail}" var="pi">
              <tr>
                <td>${pi.id}</td>
                <td>
                  <a title="点击查看原图" href="imgs/productDetail/${pi.product.id}.jpg"><img height="50px" src="imgs/productDetail/${pi.product.id}.jpg"></a>
                </td>
                <td><a deleteLink="true"
                       href="admin_productImage_delete?id=${pi.id}"><span
                    class="    glyphicon glyphicon-trash"></span></a></td>
